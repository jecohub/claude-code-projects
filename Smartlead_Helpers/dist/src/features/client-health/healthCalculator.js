 ...
 */
export function getHealthStatus(daysRemaining, hasLeadsRemaining) {
    if (!hasLeadsRemaining)
        return 'Empty';
    if (daysRemaining <= 1)
        return 'Low';
    if (daysRemaining <= 4)
 ...
 */
export function getTrendDirection(percentChange) {
 ...
 */
export function countSendingDays(startDate, endDate, sendingDays) {
 ...
 */
export function projectRunOutDate(fromDate, sendingDaysNeeded, sendingDays) {
 ...
 */
export function getLeadSequencePosition(lead) {
 ...
 */
export function calculateEmailsRemaining(sequencePosition, totalSequenceSteps) {
