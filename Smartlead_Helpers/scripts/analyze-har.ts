...
/**
 * Analyzes HAR (HTTP Archive) file to find Smartlead API calls
 *
 * To export HAR file:
 * 1. Open DevTools Network tab
 * 2. Right-click in the network list
 * 3. Select "Save all as HAR with content"
 * 4. Save to this project directory as "smartlead-capture.har"
 */
...
function analyzeHAR(harFilePath: string) {
