import type { ClientCampaignReport, CampaignHealth, TrendDirection } from '../../core/types.js';
 ...
 */
export function formatHealthSection(health: CampaignHealth, clientName?: string, clientId?: string): string {
  const lines: string[] = [];
